                        ...
                        <div className="mx-auto max-w-7xl space-y-6">
                            ...
                            <Alert className="border-blue-200 bg-blue-50">
                                ...
                                <AlertDescription className="text-blue-800">
                                    Welcome to the Secretary Dashboard! Here you'll find guidelines and best practices for managing community events
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-2 text-sm text-gray-600">
                                        <p>
                                            If you encounter any issues or need assistance with your secretary duties, please contact the system
                                            administrator or refer to the user manual.
                                        </p>
                                        <p className="font-medium text-gray-900">
                                            Remember: Your role is crucial in maintaining smooth community operations and ensuring residents have
                                            access to quality events and services.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
