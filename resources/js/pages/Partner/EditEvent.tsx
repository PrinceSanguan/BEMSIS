...
export default function EditEvent({ event, puroks }: EditEventProps) {
    ...
    const handleBack = () => {
        router.get(route('partner.events'));
    };
                        ...
                        <div className="mx-auto max-w-3xl space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Update event request details</p>
                                </div>
                            </div>
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle>Event Request Details</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                {data.start_date && (
                                                    <p className="mt-1 text-sm text-gray-500">Must be at least 1 hour after start date</p>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <Button type="submit" disabled={processing}>
                                                {processing ? 'Updating...' : 'Update Event Request'}
                                            </Button>
                                        </div>
                                    </form>
                                </CardContent>
